...
date_default_timezone_set('Asia/Ho_Chi_Minh');
 ?>
<div class="col-sm-12 col-md-12 bg-success"  style="width: 900px; height: 800px ; overflow-y: scroll;">
	<h3 class="text-center text-warning">Danh sách đơn vị vận chuyển</h3>
	<table class="table table-bordered table-hover">
		<tr>
			<th style="width: 50px;">STT</th>
			<th style="width: 150px;">Mã bài đăng</th>
			<th style="width: 450px;">Chủ xe</th>
		...
		<tr>
			<td><?php echo $i; ?></td>
			<td><a href="?menu=chitiet_vc&mavc=<?php echo $row['ma_vc'] ?>">Xem chi tiết</a></td>
			...
			<td><a class="btn btn-danger"  href="?menu=xoa_vc&mavc=<?php echo $row['ma_vc'] ?>" onclick="return confirm('Bạn chắc chắn muốn xóa bài đăng')"><span class="glyphicon glyphicon-trash"></span>  Xóa bài </a></td>
		</tr>
	<?php $i++; endwhile;?>
	</table>
</div>