...
<?php 
$search= $_GET['search'];
$qrpt= mysqli_query($connect,"select count(ma_bai_dang) as tong from sanphamgiaicuu where ten_sp like '%$search%'");
...
<?php 
	...
	// include('connect.php');
	$sl= "select * from sanphamgiaicuu where ten_sp like '%$search%' LIMIT $start, $limit";
    ...
    // ngược lại hiển thị thẻ a
				if ($i == $trang){
					...
					echo '<a href="index.php?menu=search&page='.$i.'">'.$i.'</a> ';
				}
			} ?></li>
