...
if(isset($_GET['thamso'])){
	...
	switch($thamso){ 
		...
		break;
		case 'themnguoidung':
			include 'quan_tri/qlnguoidung/themnguoidung.php';
			break;
		case 'ex_them_nd':
			include 'quan_tri/qlnguoidung/ex_themnguoidung.php';
			break;
		case 'ql_nguoidung':
		...
		break;
		case 'qlloai':
			include ('quan_tri/qlloai/qlloai.php');
			break;
		case 'sua_loai':
			include 'quan_tri/qlloai/sualoai.php';
			break;
		case 'luu_loai':
			include 'quan_tri/qlloai/ex_sualoai.php';
			break;
		case 'themmoi':
			include 'quan_tri/qlloai/themmoi.php';
			break;
		case 'ex_themloai':
			include 'quan_tri/qlloai/ex_themmoi.php';
			break;
		case 'xoa_loai':
			include 'quan_tri/qlloai/xoa.php';
			break;
			//thống kê 
		case 'tk_baidang':
			include 'quan_tri/thongke/thongkebaidang.php';
			break;
